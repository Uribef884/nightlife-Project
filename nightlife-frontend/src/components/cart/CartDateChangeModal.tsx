...
interface CartDateChangeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onClearCart: () => void;
}

export function CartDateChangeModal({
  isOpen,
  onClose,
  onClearCart,
}: CartDateChangeModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-slate-900 border border-slate-700 rounded-lg p-6 mx-4 max-w-md w-full">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">
              Tienes elementos en tu carrito
            </p>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          Para cambiar la fecha, primero vacía tu carrito o revisa tus elementos.
          </p>
        </div>
