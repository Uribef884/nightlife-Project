      ...
      <div className="relative bg-slate-900 border border-slate-700 rounded-lg p-6 mx-4 max-w-md w-full">
        ...
        <div className="mb-6">
          <p className="text-slate-200 leading-relaxed">
            Hubo cambios en la información. ¿Desea guardar los cambios?
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            onClick={onClose}
            className="w-full bg-transparent hover:bg-slate-800/50 text-slate-500 hover:text-slate-300 font-medium py-2 px-4 rounded-md transition-colors"
          >
            Cancelar
          </button>
        </div>
