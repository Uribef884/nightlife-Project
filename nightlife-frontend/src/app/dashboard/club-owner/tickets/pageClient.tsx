...
import { TicketsManagement } from '@/components/dashboard/club-owner/tickets/TicketsManagement';
  ...
  return (
    <ProtectedRoute>
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
        <ClubOwnerSidebar selectedClub={selectedClub} activeSection="tickets" />
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-auto p-4 sm:p-6">
            <div className="max-w-7xl mx-auto">
              {selectedClub ? (
                <TicketsManagement clubId={selectedClub} />
              ) : (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-600 dark:text-gray-400">
                            Por favor selecciona un club para gestionar sus entradas.
                          </p>
                        </div>
              )}
            </div>
