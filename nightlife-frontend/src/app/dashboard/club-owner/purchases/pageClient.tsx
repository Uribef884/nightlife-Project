...
import { PurchasesHistory } from '@/components/dashboard/club-owner/purchases/PurchasesHistory';
  ...
  return (
    <ProtectedRoute>
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
        <ClubOwnerSidebar selectedClub={selectedClub} activeSection="purchases" />
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                            Ve todas las compras de entradas y menú de tu club
                  </p>
                </div>
          ...
          <main className="flex-1 overflow-auto p-4 sm:p-6">
            <div className="max-w-7xl mx-auto">
              {selectedClub ? (
                <PurchasesHistory clubId={selectedClub} />
              ) : (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                            Por favor selecciona un club para ver su historial de compras.
                  </p>
                </div>
              )}
            </div>
