    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="text-center text-slate-300">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-red-500/20 rounded-full mb-6 animate-spin">
            <svg className="animate-spin h-10 w-10 text-red-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 text-lg mb-4">
            Tu transacción no pudo ser procesada correctamente.
          </p>

          <div className="bg-red-900/20 border border-red-500/50 rounded-lg p-4 max-w-md mx-auto mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                ...
                <span className="text-red-400 font-medium text-sm sm:text-base">RECHAZADO</span>
              </div>
        ...
        <div className="bg-slate-800/30 border border-slate-700/40 rounded-lg p-4 sm:p-6 text-center">
          <h3 className="text-slate-100 font-medium mb-2">¿Necesitas ayuda?</h3>
